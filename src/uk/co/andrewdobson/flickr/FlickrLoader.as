package uk.co.andrewdobson.flickr 
{
	...
	public class FlickrLoader extends EventDispatcher
	{
        ...
        private static const FLICKR_API:String = "73c9634b523f4e1aaaee3b93c10f3a46";
					//Secret: 30c0832957f5ee7d
		...
		private function onJSONLoaded( e:Event ):void
		{
	        ...
	        var rawData:String = e.currentTarget.data as String;
           ...
           /*
	        ...
	        for( var i:uint; i < photos.length; i++ ){
	        	_data.push( new Object (photos[i].title.toString(), "http://farm" + photos[i].farm + ".static.flickr.com/" + photos[i].server + "/" + photos[i].id + "_" + photos[i].secret + ".jpg")); 
	        }*/
