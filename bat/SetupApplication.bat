...
:: Android packaging
set AND_CERT_NAME="AmbientBox Mobile"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\AmbientBoxMobile.p12
...
set IOS_DEV_CERT_PASS=SeaHawk22
set IOS_PROVISION=cert\iphone_dev.mobileprovision
...
set APP_ID=com.gfleming.andy.ambientboxtest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=AmbientBoxMobile
